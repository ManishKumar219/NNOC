                ...
                <Container  className=' p-4 brr'>
                    <Row>
                        <Col sm className='bg-white bs p-4 brr m-3' style={{height: 'max-content'}}>
                            ...
                            <p className='stc pt-2'><MailIcon sx={{ color: '#fbbf22', }} className='icon' /> newnaturaloilcorporation@gmail.com</p>
                            <p className='stc pt-2'><MailIcon sx={{ color: '#fbbf22', }} className='icon' /> rsnpetroleum@gmail.com</p>
