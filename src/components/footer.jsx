        ...
        {/* <Container> */}
            <Row>
                ...
                <Col className='text-center'>
                    ...
                    <p><a href="" className='stc link'> Gallery</a></p>
                    <p><a href="" className='stc link'> Contact</a></p>
                ...
                <Col className='text-center'>
                    ...
                    <p className='stc'><MailIcon sx={{ color: '#fbbf22', fontSize: '1.2em' }} /> nnoc@gmail.com</p>
